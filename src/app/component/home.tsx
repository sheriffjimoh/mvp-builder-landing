      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 mt-40 md:mt-0">
        <div className="max-w-7xl mx-auto text-center space-y-8 relative z-10">
          ...
          <div className="animate-fade-in-up delay-400 flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
            ...
            <Link href="https://jimohsherifdeen.vercel.app/projects" target='_blank' className="group border-2 border-white/20 hover:border-white/40 backdrop-blur-sm px-8 py-6 rounded-2xl text-xl font-semibold text-white hover:bg-white/5 transition-all duration-300">
          ...
          <div className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl md:p-16 p-8 relative overflow-hidden">
            <div className="relative z-10 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                 <Link href="mailto:jimohsherifdeen6@gmail.com"  className="bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-600 px-12 py-6 rounded-2xl text-xl font-bold text-white shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 hover:scale-105">
                  Start Your Project →
                </Link>
                
                <Link href="https://calendly.com/jimohsherifdeen6/30min" target='_blank'  className="border-2 border-white/20 hover:border-white/40 backdrop-blur-sm px-8 py-6 rounded-2xl text-xl font-semibold text-white hover:bg-white/5 transition-all duration-300">
                  Schedule a Call
                </Link>
              </div>
            </div>
          ...
          <Link  href="/" className="text-xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
            ...
            <div className="flex items-center space-x-8">
              ...
              <span className="text-gray-500">Owned by </span>
                ...
                <a href="https://jimohsherifdeen.vercel.app" target="_blank" className=" ml-2 text-purple-400 hover:text-purple-300 transition-colors">
                  Jimoh Sherifdeen
                </a>
                </div>
            </div>
